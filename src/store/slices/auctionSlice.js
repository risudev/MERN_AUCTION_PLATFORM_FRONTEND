...
//       "https://mern-auction-platform-backend-n55f.onrender.com/api/v1/auctionitem/allitems",
...
//   try {
//     const response = await axios.get(
//       "https://mern-auction-platform-backend-n55f.onrender.com/api/v1/auctionitem/myitems",
//       { withCredentials: true }
//     );
...
//   try {
//     const response = await axios.get(
//       `https://mern-auction-platform-backend-n55f.onrender.com/api/v1/auctionitem/auction/${id}`,
//       { withCredentials: true }
//     );
...
//       "https://mern-auction-platform-backend-n55f.onrender.com/api/v1/auctionitem/create",
//       data,
//       {
//         withCredentials: true,
...
//       `https://mern-auction-platform-backend-n55f.onrender.com/api/v1/auctionitem/item/republish/${id}`,
//       data,
//       {
//         withCredentials: true,
...
//       `https://mern-auction-platform-backend-n55f.onrender.com/api/v1/auctionitem/delete/${id}`,
//       {
//         withCredentials: true,
//       }
//     );
